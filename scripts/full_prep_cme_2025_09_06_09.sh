...
BASE_DIR="/glade/work/rjarolim/data/sunerf-cme/2025_09_06_09_1200"

# The download helpers treat --end as exclusive. Use +1 second so 2025-09-09T12:00:00 is included.
START_TS="2025-09-06T00:00:00"
END_TS="2025-09-09T12:00:01"

CCOR_RAW_DIR="${BASE_DIR}/ccor_l2"
COR_RAW_DIR="${BASE_DIR}/cor"
COR_PREP_DIR="${BASE_DIR}/cor_prep"
COR_CLEAR_RAW_DIR="${COR_RAW_DIR}/clear"
PUNCH_PAM_RAW_DIR="${BASE_DIR}/punch_pam"
...
echo "Downloading PUNCH PAM full cadence"
