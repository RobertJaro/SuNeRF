...
python -m sunerf.data.coronagraph.compute_correction --input "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_a_cor2/tB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/masks/stereo_a_cor2_tB_correction.npy"
python -m sunerf.data.coronagraph.compute_correction --input "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_a_cor2/pB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/masks/stereo_a_cor2_pB_correction.npy"
python -m sunerf.data.coronagraph.compute_correction --input "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_b_cor2/tB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/masks/stereo_b_cor2_tB_correction.npy"
python -m sunerf.data.coronagraph.compute_correction --input "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_b_cor2/pB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/masks/stereo_b_cor2_pB_correction.npy"
...
python -m sunerf.evaluation.cme.plot_ref_series --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/201208_cor2_v01/save_state.snf" --ref_map "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_a_cor2/pB/*"
python -m sunerf.evaluation.cme.plot_ref_series --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/201208_cor2_v01/save_state.snf" --ref_map "/glade/work/rjarolim/data/sunerf-cme/2012_08/prep/stereo_b_cor2/pB/*" --out_path "/glade/work/rjarolim/sunerf-cme-obs/201208_cor2_v01/ref_series_stereo_b"

python -m sunerf.evaluation.cme.video --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/201208_cor2_v02/save_state.snf"
python -m sunerf.evaluation.cme.video_polar --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/201208_cor2_v02/save_state.snf"
