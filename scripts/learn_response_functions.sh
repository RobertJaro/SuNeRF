...
python -m sunerf.train.convert_temperature_response_function --response_file '/glade/work/rjarolim/sunerf/response/aia_response_functions.npz' --out_file '/glade/work/rjarolim/sunerf/response_v03/aia_interpolated.npz'
...
# EUI
python -m sunerf.train.convert_temperature_response_function --response_file '/glade/work/rjarolim/sunerf/response/eui_response_functions.npz' --out_file '/glade/work/rjarolim/sunerf/response_v03/eui_interpolated.npz'
