...
python -m sunerf.data.coronagraph.prep_punch_pam \
  ...
  --resize 512 512 \
  --num_workers 16 \
  --value_max 1.0e-11 --value_min 1.0e-15
...
python -m sunerf.data.coronagraph.compute_correction --type daily-min --input "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/cor2/tB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/masks/stereo_a_cor2_tB_correction.npy"
python -m sunerf.data.coronagraph.compute_correction --type daily-min --input "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/cor2/pB/*" --output "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/masks/stereo_a_cor2_pB_correction.npy"
python -m sunerf.data.coronagraph.compute_correction --type daily-min --input "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/ccor/*" --output "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/masks/ccor_tB_correction.npy"
...
python -m sunerf.evaluation.cme.carrington_map_comparison \
  --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/save_state.snf" \
  --aia_glob "/glade/work/rjarolim/data/sunerf-cme/aia_validation/2025_09/*.fits"

python -m sunerf.evaluation.cme.video_polar --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/save_state.snf"
python -m sunerf.evaluation.cme.video --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/save_state.snf"
python -m sunerf.evaluation.cme.video_fixed_rotation --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/save_state.snf" --occ_range 3 20
python -m sunerf.evaluation.cme.plot_tomography --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_cor2_ccor_v04/save_state.snf" --longitudes 90 100 110 120 130 140 150 160 --time_range "2025-09-06T12:00" "2025-09-07T06:00"


python -m sunerf.evaluation.cme.plot_ref_series --sunerf_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/save_state.snf" --out_path "/glade/work/rjarolim/sunerf-cme-obs/2025_09_v01/punch" --ref_map "/glade/work/rjarolim/data/sunerf-cme/2025_09/prep/punch_cam/*"
...
python -m sunerf.evaluation.cme.plot_coverage \
  ...
  --pb-label "PUNCH/WFI" \
  --out-path "/glade/work/rjarolim/sunerf-cme-obs/coverage_2025_09.png" \
