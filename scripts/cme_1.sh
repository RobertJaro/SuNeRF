...
##################################################
# Evaluation
python -m sunerf.evaluation.cme.cme_tomography --sunerf_path "/glade/work/rjarolim/sunerf-cme-v2/cme1_2view_v02/save_state.snf" --data_path "/glade/work/rjarolim/data/sunerf-cme/cme1/density_cube/*.sav" --min_longitude 0 --max_longitude 180 --plot_ground_truth --target_longitude 60 --target_latitude -25 --date0 "2010-05-27T07:04:39.000"
python -m sunerf.evaluation.cme.cme_tomography --sunerf_path "/glade/work/rjarolim/sunerf-cme-v2/cme1_3view_v02/save_state.snf" --data_path "/glade/work/rjarolim/data/sunerf-cme/cme1/density_cube/*.sav" --min_longitude 0 --max_longitude 180 --plot_ground_truth --target_longitude 60 --target_latitude -25 --date0 "2010-05-27T07:04:39.000"
python -m sunerf.evaluation.cme.cme_tomography --sunerf_path "/glade/work/rjarolim/sunerf-cme-v2/cme1_4view_v03/save_state.snf" --data_path "/glade/work/rjarolim/data/sunerf-cme/cme1/density_cube/*.sav" --min_longitude 0 --max_longitude 180 --plot_ground_truth --target_longitude 60 --target_latitude -25 --date0 "2010-05-27T07:04:39.000"
