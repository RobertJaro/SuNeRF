...
if __name__ == '__main__':
    ...
    files += ['/glade/work/rjarolim/sunerf-cme-v2/polar_v01/evaluation/center_of_mass.npz']
    files += ['/glade/work/rjarolim/sunerf-cme-v2/helio_v03/evaluation/center_of_mass.npz']
    angles = [0, 40, 80, 120, 160, 200, 240, 280, 320, 20, 340]
    ...
    l5 = ax.scatter(angles[-1], velocity_com_diffs[-1], label='3 views')
    ...
    # add legend axis
    fig.legend(loc='outside upper center', handles=[l1, l2, l3, l4, l5], ncol=5, fontsize=8, fancybox=True, shadow=False,
