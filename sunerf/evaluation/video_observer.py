...
start_time = loader.start_time('AIA_SUB')
end_time = loader.end_time('AIA_SUB')
...
center_coord = loader.ref_map('AIA_SUB').center.transform_to(frames.HeliographicCarrington)
