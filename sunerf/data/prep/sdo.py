...
from sunerf.data.utils import sdo_norms
...
if __name__ == '__main__':
    ...
    group.add_argument('--hgc_lon', dest='hgc_lon', type=float, help='carrington longitude of the frame center.',
                       required=True)
    group.add_argument('--hgc_lat', dest='hgc_lat', type=float, help='carrington latitude of the frame center.',
                       required=True)
