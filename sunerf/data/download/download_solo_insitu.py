"""Download Solar Orbiter in-situ CDF products from CDAWeb."""
...
DEFAULT_DATASETS = ("SOLO_COHO1HR_MERGED_MAG_PLASMA",)


def download(request, *, datasets=DEFAULT_DATASETS):
    return download_cdaweb(request, datasets, mission="Solar Orbiter")
