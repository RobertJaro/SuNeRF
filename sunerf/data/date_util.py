...
def normalize_datetime(date, seconds_per_dt, ref_date):
    ...
    normalized date
    """
    return (date - ref_date).total_seconds() / seconds_per_dt


def unnormalize_datetime(norm_date: float, seconds_per_dt, ref_date) -> datetime:
